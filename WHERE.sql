...
-- SELECT  columns Gene_ID, RPKM from the table rnaseq WHERE Gene_length BETWEEN 200 AND 400;
SELECT Gene_ID, RPKM FROM rnaseq WHERE Gene_length BETWEEN 200 AND 400;
-- SELECT  columns Gene_ID, RPKM from the table rnaseq WHERE Gene_length<=800;
SELECT Gene_ID, RPKM FROM rnaseq WHERE Gene_length<=800;
